...
custom6: [替代 mod6] Ctrl+N custom model 切换 (_find_at_or_near 容错, 与 mod6 二选一)
...
select: 1,2,3,4,5,6,7,8,9,custom6,custom7,custom8 / all / restore
```
...
| custom6 | model cycle | peek/cycle 函数 | 覆盖H+移除检查 | 0 | [替代 mod6] 容错版，与 mod6 二选一 |
...
### Custom 6: [替代 mod6] 容错版 Ctrl+N custom model 切换
...
mods/custom6_custom_model_cycle.py     # [替代 mod6] 容错版 custom model 切换 (0 bytes)

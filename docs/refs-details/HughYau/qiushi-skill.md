...
- [事实] 提交数：`21`
- [事实] 代表提交：
  - `2026-04-10` `feat: 添加案例分享`
  - `2026-04-09` `feat: 更新方法论边界说明，明确项目定位与适用场景`
  - `2026-04-09` `feat: 添加展示示例和真实案例分享部分`
  - `2026-04-08` `feat: 更新安装方式，添加通过 Claude Plugin Hub 安装的推荐方法`
- [推断] 新增案例分享/展示示例，补强方法论边界与安装路径说明，增加站点入口页（`index.html`/`.nojekyll`）与 README 展示增强，并加入 ASCII JSON 字符串处理能力。
<!-- recent-updates:end -->
